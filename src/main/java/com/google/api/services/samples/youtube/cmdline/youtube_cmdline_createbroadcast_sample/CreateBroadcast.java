...
public class CreateBroadcast {
  ...
  public static void main(String[] args) {
    ...
    // Scope required to write data to YouTube.
  ...
  /**
   *
   * Returns a title (String) for stream or broadcast from user via the terminal.
   *
   * @param resource Resource type ("broadcast" or "stream")
   */
  private static String getTitle(String resource) throws IOException { String title = "";

    System.out.print("Please enter a " + resource + "title: ");
